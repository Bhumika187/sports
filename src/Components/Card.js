...
const Card = () => {
  ...
  return (
    <div className={`flex flex-col justify-center items-center min-h-screen transition duration-500 ${darkMode ? 'bg-gradient-to-br from-white via-[#18282A] to-[#221A2C] text-white' : 'bg-white text-black'}`}>
  ...
  <div>
    <img src="assets/img22.png" alt="lorem-img" className="card-img" />
      ...
      {/* <button
        ...
        className="absolute top-4 right-4 px-4 py-2 rounded-lg shadow-md bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200"
      >
